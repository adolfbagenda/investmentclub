    ...
    <div class="row">
      ...
      @endif
        <div class="card">
          ...
          <form action="{{route('investmentclub.general_settings.update')}}" method="POST">
            {{csrf_field() }}
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="col-md-12">
              <form role="form" action="{{route('investmentclub.general_settings.store')}}" method="POST" enctype="multipart/form-data" aria-label="Adding Field Content">
              {{csrf_field() }}
