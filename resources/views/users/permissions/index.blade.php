        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="col-md-12">
              <form role="form" action="{{route('investmentclub.users.permissions.store')}}" method="POST" enctype="multipart/form-data" >
              {{csrf_field() }}
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="col-md-12">
              <form role="form" action="{{route('investmentclub.users.permissions.update','hhh')}}" method="POST" enctype="multipart/form-data" >
              {{csrf_field() }}
